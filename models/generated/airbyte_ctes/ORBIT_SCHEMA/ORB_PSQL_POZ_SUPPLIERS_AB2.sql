...
select
    cast(case DF_SCORE when '' then 0 else DF_SCORE end as {{ dbt_utils.type_float() }}) as DF_SCORE,
    cast(case PARTY_ID when '' then 0 else PARTY_ID end as {{ dbt_utils.type_float() }}) as PARTY_ID,
    ...
    cast(case VENDOR_ID when '' then 0 else VENDOR_ID end as {{ dbt_utils.type_float() }}) as VENDOR_ID,
    ...
    cast(case PROGRAM_ID when '' then 0 else PROGRAM_ID end as {{ dbt_utils.type_float() }}) as PROGRAM_ID,
    cast(case REQUEST_ID when '' then 0 else REQUEST_ID end as {{ dbt_utils.type_float() }}) as REQUEST_ID,
    ...
    cast(case EMPLOYEE_ID when '' then 0 else EMPLOYEE_ID end as {{ dbt_utils.type_float() }}) as EMPLOYEE_ID,
    cast(REVIEW_TYPE as {{ dbt_utils.type_string() }}) as REVIEW_TYPE,
    cast(case AWT_GROUP_ID when '' then 0 else AWT_GROUP_ID end as {{ dbt_utils.type_float() }}) as AWT_GROUP_ID,
    ...
    cast(case PARENT_PARTY_ID when '' then 0 else PARENT_PARTY_ID end as {{ dbt_utils.type_float() }}) as PARENT_PARTY_ID,
    cast(case SET_OF_BOOKS_ID when '' then 0 else SET_OF_BOOKS_ID end as {{ dbt_utils.type_float() }}) as SET_OF_BOOKS_ID,
    ...
    ,
    cast(case MIN_ORDER_AMOUNT when '' then 0 else MIN_ORDER_AMOUNT end as {{ dbt_utils.type_float() }}) as MIN_ORDER_AMOUNT,
    cast(case PARENT_VENDOR_ID when '' then 0 else PARENT_VENDOR_ID end as {{ dbt_utils.type_float() }}) as PARENT_VENDOR_ID,
    ...
    cast(case ATTRIBUTE_NUMBER1 when '' then 0 else ATTRIBUTE_NUMBER1 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER1,
    cast(case ATTRIBUTE_NUMBER2 when '' then 0 else ATTRIBUTE_NUMBER2 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER2,
    cast(case ATTRIBUTE_NUMBER3 when '' then 0 else ATTRIBUTE_NUMBER3 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER3,
    cast(case ATTRIBUTE_NUMBER4 when '' then 0 else ATTRIBUTE_NUMBER4 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER4,
    cast(case ATTRIBUTE_NUMBER5 when '' then 0 else ATTRIBUTE_NUMBER5 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER5,
    cast(case ATTRIBUTE_NUMBER6 when '' then 0 else ATTRIBUTE_NUMBER6 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER6,
    cast(case ATTRIBUTE_NUMBER7 when '' then 0 else ATTRIBUTE_NUMBER7 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER7,
    cast(case ATTRIBUTE_NUMBER8 when '' then 0 else ATTRIBUTE_NUMBER8 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER8,
    cast(case ATTRIBUTE_NUMBER9 when '' then 0 else ATTRIBUTE_NUMBER9 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER9,
    cast(case CHANGE_REQ_NUMBER when '' then 0 else CHANGE_REQ_NUMBER end as {{ dbt_utils.type_float() }}) as CHANGE_REQ_NUMBER,
    ...
    cast(case ATTRIBUTE_NUMBER10 when '' then 0 else ATTRIBUTE_NUMBER10 end as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER10,
    ...
    cast(case EXTERNAL_SYSTEM_ID when '' then 0 else EXTERNAL_SYSTEM_ID end as {{ dbt_utils.type_float() }}) as EXTERNAL_SYSTEM_ID,
    ...
    cast(case OBJECT_VERSION_NUMBER when '' then 0 else OBJECT_VERSION_NUMBER end as {{ dbt_utils.type_float() }}) as OBJECT_VERSION_NUMBER,
    ...
    cast(case GLOBAL_ATTRIBUTE_NUMBER1 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER1 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER1,
    cast(case GLOBAL_ATTRIBUTE_NUMBER2 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER2 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER2,
    cast(case GLOBAL_ATTRIBUTE_NUMBER3 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER3 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER3,
    cast(case GLOBAL_ATTRIBUTE_NUMBER4 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER4 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER4,
    cast(case GLOBAL_ATTRIBUTE_NUMBER5 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER5 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER5,
    cast(case GLOBAL_ATTRIBUTE_NUMBER6 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER6 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER6,
    cast(case GLOBAL_ATTRIBUTE_NUMBER7 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER7 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER7,
    cast(case GLOBAL_ATTRIBUTE_NUMBER8 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER8 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER8,
    cast(case GLOBAL_ATTRIBUTE_NUMBER9 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER9 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER9,
    ...
    cast(case GLOBAL_ATTRIBUTE_NUMBER10 when '' then 0 else GLOBAL_ATTRIBUTE_NUMBER10 end as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER10,
