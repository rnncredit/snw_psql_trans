...
select
    ...
    cast(TRY_TO_NUMBER(ATTRIBUTE_NUMBER4)  as {{ dbt_utils.type_float() }}) as ATTRIBUTE_NUMBER4,
    ...
    cast(TRY_TO_NUMBER(PROGRAM_APPLICATION_ID) as {{ dbt_utils.type_float() }}) as PROGRAM_APPLICATION_ID,
    ...
    cast(TRY_TO_NUMBER(GLOBAL_ATTRIBUTE_NUMBER2)  as {{ dbt_utils.type_float() }}) as GLOBAL_ATTRIBUTE_NUMBER2,
